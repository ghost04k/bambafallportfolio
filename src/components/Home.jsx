...
import JessicaMainImg from "../assets/images/profil.JPG";
import CircularImg from "../assets/images/logocercle.png";
import FlowerImg from "../assets/images/flower.png";
import BrandLogo1 from "../assets/images/sncf.png";
import BrandLogo2 from "../assets/images/kpa6T.png";
import BrandLogo3 from "../assets/images/epsi.png";
import BrandLogo4 from "../assets/images/NIIT.png";
...
import $ from "jquery";
import CV from "../assets/pdf/bamba_resume.pdf";
    ...
    <img style={{ width: '30px' }} src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="github-svg" />
      ...
      <div className="main-containe" data-bs-spy="scroll">
          ...
          <div className="row">
            ...
            <div className="col-xxl-6 col-lg-6 position-relative">
              ...
              <div className="worked-box">
                <p className="worked-more">Le code construit l’expérience, les données lui donnent du sens.Ensemble, ils transforment le digital</p>
        ...
        {/* <section className="Marquee-main overflow-hidden">
          <h3 className="fade_up">Impossible is nothing</h3>
